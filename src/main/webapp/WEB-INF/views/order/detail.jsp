...
<jsp:include page="../layout/header.jsp">
  ...
  <hr>
    ...
    <div>
      <label for="orderTell">휴대전화</label>
      <input type="text" name="orderTell" id="orderTell">
    ...
    <div>
      ...
      <input type="text" name="reTell" id="reTell">
      <span id="re_tell"></span>
    </div>
    ...
    <div>    
      ...
      <textarea placeholder="배송요청사항"></textarea>
    </div>
