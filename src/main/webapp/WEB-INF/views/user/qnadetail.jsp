...
<div>
    <div class="text-center">
        <c:if test="${sessionScope.user.userNo == qna.userDto.userNo}">
            <form id="frn_btn" method="post" enctype="multipart/form-data"> <!-- Add enctype attribute -->
...
<tr class="blind write_tr">
    <td colspan="4">
        <form method="post" action="${contextPath}/user/qnadetail/addReply.do" enctype="multipart/form-data"> <!-- Add enctype attribute -->
	            ...
	            <div class="input-group">
	                <label for="contaents" class="input-group-text">내용</label>
